...
namespace CRM.Model
{
    ...
    public class NewLeadsData : BaseModel
    {
        ...
        private bool _isCallVisible = false;
        public bool isCallVisible
        {
            get => _isCallVisible;
            set { _isCallVisible = value; OnPropertyChanged(); }
        }

        private bool _isCopyVisible = false;
        public bool isCopyVisible
        {
            get => _isCopyVisible;
            set { _isCopyVisible = value; OnPropertyChanged(); }
        }
        private bool _isCheckBoxVisible = false;
        public bool isCheckBoxVisible
        {
            get => _isCheckBoxVisible;
            set { _isCheckBoxVisible = value; OnPropertyChanged(); }
        }
    }
}
